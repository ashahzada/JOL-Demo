...
public class Constants {
	...
	public static final EasyTime MEETING_START = new EasyTime(10, 0);
	
	/** Average duration of meetings. */
	public static final EasyTime MEETING_DURATION = new EasyTime(1, 00);
	
	/** Time for the daily Lunch. */
	public static final EasyTime LUNCH_START = new EasyTime(13, 0);
	
	/** Average duration of Lunch. */
	public static final EasyTime LUNCH_DURATION = new EasyTime(0,45);
	
	/** Blur of the meeting duration. */
	public static final int LUNCH_DURATION_BLUR = 15;

	/** Blur of the meeting duration. */
	public static final int MEETING_DURATION_BLUR = 30;
	
	/** Time for the daily demo. */
	public static final EasyTime DEMO_START = new EasyTime(14, 30);
	
	/** Average duration of demo. */
	public static final EasyTime DEMO_DURATION = new EasyTime(1,00);
	
	/** Blur of the  demo. */
	public static final int DEMO_DURATION_BLUR = 15;
	...
	/** Name says all. */
	public static final int TOILET_VISIT_DURATION = 10;
	...
	enum Activity implements Publishable {
		...
		/** The agent is going for lunch. */
		GOING_2_LUNCH("Going2Lunch"),
		
		GOING_2_DEMO("Going2Demo"),
		...
		/** The agent is entering in the kitchen. */
		AT_KITCHEN("AtKitchen"),
		/** The agent is entering in the kitchen. */
		ENTERING_KITCHEN("EnteringKitchen"),
